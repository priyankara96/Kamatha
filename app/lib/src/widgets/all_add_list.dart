...
class AllAddList extends StatefulWidget {
  const AllAddList({required User user}) : _user = user;
  final User _user;
  @override
  State<AllAddList> createState() => _AllAddListState();
}

class _AllAddListState extends State<AllAddList> {
  late User _user;
