...
import 'package:Kamataha/src/screens/display_news.dart';
import 'package:Kamataha/src/utils/database.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class AllNewsDisplayList extends StatefulWidget {
  const AllNewsDisplayList({required User user}) : _user = user;
  final User _user;

  @override
  State<AllNewsDisplayList> createState() => _AllNewsDisplayListState();
}

class _AllNewsDisplayListState extends State<AllNewsDisplayList> {
  late User _user;
